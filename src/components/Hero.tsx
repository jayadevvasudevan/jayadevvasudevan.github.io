      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-30" ref={containerRef}>
        <div className="flex justify-center">
          <div className="w-full max-w-4xl text-center">
            ...
            >
              Jayadev<br className="hidden sm:inline" />
              <span className="text-pulse-500">Software Developer</span><br className="inline sm:hidden" /><span className="text-pulse-500"> & Data Engineer</span>
            </h1>
            ...
            >
              ...
              <a 
                href="#projects" 
                className="flex items-center justify-center group w-full sm:w-auto text-center border-2 border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-white transition-colors duration-300" 
                style={{
                  borderRadius: '1440px',
                  boxSizing: 'border-box',
                  cursor: 'pointer',
